...
read({ edit: '.git/COMMIT_EDITMSG' })
    ...
    .then(msg => addFile(['tool/index.js','tool/addOrigin.js','tool/setOrigin.js','tool/shields.js', 'index.js','commitlint.config.js','package.json','readme.md','.travis.yml']).then(() => msg))
    .then((result) => {
        if (result.valid) {
